...
class CloudPlayerService {
  ...
  initializePlayerWithUrl(
    ...
    try {
      ...
      print(
          "Cloud player service could not initialize player with playerId = $playerId from url = $url because of error =$e");
    }
  }
  ...
  disposePlayer({@required String playerId}) async {
    try {
      ...
      print(
          "Cloud player service could not dispose player with playerId = $playerId because of error =$e");
    }
  }
  ...
  play({@required String playerId}) async {
    try {
      ...
      print(
          "Cloud player service could not play player with playerId = $playerId because of error =$e");
    }
  }
  ...
  pause({@required String playerId}) async {
    try {
      ...
      print(
          "Cloud player service could not pause player with playerId = $playerId because of error =$e");
    }
  }
  ...
  seek({@required Duration position, @required String playerId}) async {
    try {
      ...
      print(
          "Cloud player service could not seek player with playerId = $playerId to position = $position because of error =$e");
    }
  }
  ...
  setSpeed({@required double speed, @required String playerId}) async {
    try {
      ...
      print(
          "Cloud player service could not set speed to speed = $speed for player with playerId = $playerId because of error =$e");
    }
  }
  ...
  Stream<FullAudioPlaybackState> getPlaybackStateStream(
    ...
    try {
      ...
      print(
          "Cloud player service could not get playback Stream for player with playerId = $playerId because of error =$e");
      return Stream.error(
          "Cloud player service could not get playback Stream for player with playerId = $playerId because of error =$e");
    }
  }
  ...
  Stream<Duration> getPositionStream({@required String playerId}) {
    try {
      ...
      print(
          "Cloud player service could not get position Stream for player with playerId = $playerId because of error =$e");
      return Stream.error(
          "Cloud player service could not get position Stream for player with playerId = $playerId because of error =$e");
    }
  }
  ...
  Stream<Duration> getLengthOfAudioStream({@required String playerId}) {
    try {
      ...
      print(
          "Cloud player service could not get length of audio stream for player with playerId = $playerId because of error =$e");
      return Stream.error(
          "Cloud player service could not get length of audio stream for player with playerId = $playerId because of error =$e");
    }
  }
